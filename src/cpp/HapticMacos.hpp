...
#define HAPT_DEBUG_LOG_INFO(x) std::cout << "HapticMacos/Debug/Info: " << x << std::endl
#define HAPT_DEBUG_LOG_ERR(x) std::cout << "HapticMacos/Debug/Error: " << x << std::endl

// You should not call this directly! Please use the HapticMacos class.
